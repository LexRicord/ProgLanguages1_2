...
namespace In
{
	IN getin(wchar_t infile[])
	{
		...
		while (in_ex.size < IN_MAX_LEN_TEXT)
		{
			...
			if (fin.eof()) //При вызове с действительным дескриптором файла eof() возвращает 1, если был достигнут конец файла; в противном случае она возвращает 0. В случае ошибки она возвращает —1
			{
